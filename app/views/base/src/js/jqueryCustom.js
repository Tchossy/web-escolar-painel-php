...
jQuery(document).ready(function () {
  ...
  function initSlickCarousel() {
    ...
    jQuery('.testimonialSlider').slick({
      ...
      dots: true,
      dotsClass:
        'dotsList dotsListii d-flex align-items-center justify-content-center list-unstyled mb-0 mt-4 mt-lg-8',
      responsive: [
        {
          breakpoint: 992,
          settings: {
    ...
    jQuery('.arddColumnSlider').slick({
      ...
      arrows: true,
      prevArrow:
        '<a href="#" class="slickPrev ssArrowVii rounded-circle d-flex align-items-center justify-content-center fas fa-chevron-left position-absolute"><span class="sr-only">prev</span></a>',
      nextArrow:
        '<a href="#" class="slickNext ssArrowVii rounded-circle d-flex align-items-center justify-content-center fas fa-chevron-right position-absolute"><span class="sr-only">next</span></a>',
      dots: true,
      dotsClass:
        'dotsList dotsListii d-flex align-items-center justify-content-center list-unstyled mb-0 mt-4 mt-lg-8',
      responsive: [
    ...
    jQuery('.scgSpeakersSlider').slick({
      ...
      dots: true,
      dotsClass:
        'dotsList dotsListii d-flex align-items-center justify-content-center list-unstyled mb-0 mt-n12',
      arrows: false,
      responsive: [
        {
          breakpoint: 992,
...
jQuery(
  '<div class="quantity-nav"><div class="quantity-button quantity-plus d-flex align-items-center justify-content-center"><i class="fas fa-caret-up"><span class="sr-only">icon</span></i></div><div class="quantity-button quantity-minus d-flex align-items-center justify-content-center"><i class="fas fa-caret-down"><span class="sr-only">icon</span></i></div></div>'
...
$(function () {
  $('#slider-range').slider({
    ...
    slide: function (event, ui) {
      $('#amount').html('Price : $' + ui.values[0] + ' â€” $' + ui.values[1])
